...
namespace WebNhaHangOnline.Models
{
    public class NhaCungCapModel
    {
        ...
        internal string ThemHangNCC(NhaCungCap loai)
        {
            loai.MaNCC = TaoMa();
        ...
        internal NhaCungCap FindByIdNCC(string id)
        {
            return db.NhaCungCaps.Find(id);
        }


        internal void EditNCC(NhaCungCap loai)
        {
            try
            {
        ...
        internal void DeleteNhaCungCap(string id)
        {
